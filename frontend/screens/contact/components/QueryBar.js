        ...
        <View style={styles.container}>
            ...
            >
                <Ionicons
                    ...
                    size={32}
                    color={selected === null ? selectColor : iconColor}
                />
                <Text
                    style={[
                        styles.optionText,
            ...
            <TouchableOpacity
                style={styles.option}
                onPress={() => {
                    onSelectFilter('professor')
                }}
            >
                <FontAwesome5
                    name="chalkboard-teacher"
                    size={26}
                    color={selected === 'professor' ? selectColor : iconColor}
                />
                <Text
                    style={[
                        styles.optionText,
            ...
            <TouchableOpacity
                style={styles.option}
                onPress={() => {
                    onSelectFilter('officer')
                }}
            >
                <FontAwesome5
                    name="id-card-alt"
                    size={26}
                    color={selected === 'officer' ? selectColor : iconColor}
                />
                <Text
                    style={[
                        styles.optionText,
            ...
            <TouchableOpacity
                style={styles.option}
                onPress={() => {
                    onSelectFilter('student')
                }}
            >
                <Ionicons
                    name="school"
                    size={32}
                    color={selected === 'student' ? selectColor : iconColor}
                />
                <Text
                    style={
                        ([styles.optionText, styles.marginTopSmall],
                        { color: selected === 'student' ? selectColor : iconColor })
                    }
                >
                    Student
